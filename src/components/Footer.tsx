        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              ...
              <span className="text-xl font-bold tracking-tighter text-zinc-900 dark:text-white uppercase">PC Master</span>
            </div>
          ...
          <div>
            <h4 className="text-zinc-900 dark:text-white font-bold mb-6">Platform</h4>
            <ul className="space-y-4 text-sm text-zinc-600 dark:text-zinc-400">
              <li><a href="#" className="hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors">Shop Components</a></li>
              <li><a href="#" className="hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors">Assembly Guides</a></li>
              <li><a href="#" className="hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors">AI Assistant</a></li>
              <li><a href="#" className="hover:text-emerald-500 dark:hover:text-emerald-400 transition-colors">Community</a></li>
            </ul>
          </div>

          <div>
            <h4 className="text-zinc-900 dark:text-white font-bold mb-6">Connect</h4>
            <div className="flex gap-4">
              <a href="#" className="p-2 rounded-lg bg-zinc-200 dark:bg-white/5 hover:bg-zinc-300 dark:hover:bg-white/10 text-zinc-600 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-white transition-all">
